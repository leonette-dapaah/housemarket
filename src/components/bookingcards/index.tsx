...
export const BookingCard: React.FC<BookingCardProps> = ({ imageSrc, streetName, price, date, status }) => {
  ...
  return (
    <div className="w-[1400px] h-[130px] lg:w-5/5 shadow rounded-md mb-[70px] p-2 border border-1-grey mb-[200px] mt-[50px]">
      <div className="flex justify-space-between">
        ...
        <div className="flex justify-space-between ml-[860px] mt-[60px]">
          <div className="flex justify-space-between items-center">
            ...
            <button className="text-red-500 font-semibold" onClick={handleOpenCancelTour}>
              Cancel Appointment
            </button>
          </div>
        </div>
