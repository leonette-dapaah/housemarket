...
const HouseCard: React.FC<HouseCardProps> = ({ imageSrc, streetName, price, bed, created_at}) => (
  <div className="w-full lg:w-5/5 shadow-md rounded-md mb-[70px] pr-5" onClick={PropertyDetails}>
